...
/*! exports used: Badge, BadgeVariant */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return BadgeVariant; });
...
var Badge = function Badge(_ref) {
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__["jsx"])("span", {
    className: classnames__WEBPACK_IMPORTED_MODULE_4___default()({
      ...
      // Outline none
      'bg-gray-200 text-gray-600 ': BadgeVariant["default"] == variant && !outlined,
      'bg-teal-200 text-teal-600': BadgeVariant.primary == variant && !outlined,
      'bg-orange-200 text-orange-600 ': BadgeVariant.secondary == variant && !outlined,
      'bg-teal-200  text-teal-600': BadgeVariant.success == variant && !outlined,
      'bg-cyan-200 text-cyan-600': BadgeVariant.info == variant && !outlined,
      'bg-amber-200 text-amber-600': BadgeVariant.warning == variant && !outlined,
      'bg-red-200 text-red-600 ': BadgeVariant.danger == variant && !outlined,
      // Outline
      'outline outline-1 bg-transparent': outlined,
      'bg-transparent text-gray-600 outline-gray-600': BadgeVariant["default"] == variant && outlined,
      'bg-transparent text-teal-300 outline-teal-300': BadgeVariant.primary == variant && outlined,
      'bg-transparent text-orange-400 outline-orange-400': BadgeVariant.secondary == variant && outlined,
      'bg-transparent text-teal-400 outline-teal-400': BadgeVariant.success == variant && outlined,
      'bg-transparent text-cyan-300 outline-cyan-300': BadgeVariant.info == variant && outlined,
      'bg-transparent text-amber-400 outline-amber-400': BadgeVariant.warning == variant && outlined,
      'bg-transparent text-red-400 outline-red-400': BadgeVariant.danger == variant && outlined,
      'rounded': rounded
    }),
    children: label
  });
...
//# sourceMappingURL=main.a8954e1cfd5b6dbd613b.hot-update.js.map