...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__["jsx"])("button", {
    className: classnames__WEBPACK_IMPORTED_MODULE_4___default()({
      ...
      'text-gray-600 outline-gray-600  active:outline-gray-700 hover:outline-gray-700': ButtonVariant["default"] == variant && outlined,
      'text-teal-300 outline-teal-300  active:outline-teal-500 hover:outline-teal-500': ButtonVariant.primary == variant && outlined,
      'text-orange-400 outline-orange-400  active:outline-oraginge-600 hover:outline-oraginge-600': ButtonVariant.secondary == variant && outlined,
      'text-teal-400 outline-teal-400  active:outline-teal-500 hover:outline-teal-500': ButtonVariant.success == variant && outlined,
      'text-cyan-300 outline-cyan-300  active:outline-cyan-500 hover:outline-cyan-500': ButtonVariant.info == variant && outlined,
      'text-amber-400 outline-amber-400  active:outline-amber-500 hover:outline-amber-500': ButtonVariant.warning == variant && outlined,
      'text-red-400 outline-red-400  active:outline-red-500 hover:outline-red-500': ButtonVariant.danger == variant && outlined
    }),
    children: label
  });
};
...
//# sourceMappingURL=main.2d42dbd2c741949f372f.hot-update.js.map