...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__["jsx"])("button", {
    className: classnames__WEBPACK_IMPORTED_MODULE_4___default()({
      ...
      'text-gray-600 outline-gray-600 text-white active:outline-gray-700 hover:outline-gray-700': ButtonVariant["default"] == variant && outlined,
      'text-teal-300 outline-teal-300 text-white active:outline-teal-500 hover:outline-teal-500': ButtonVariant.primary == variant && outlined,
      'text-orange-400 outline-orange-400 text-white active:outline-oraginge-600 hover:outline-oraginge-600': ButtonVariant.secondary == variant && outlined,
      'text-teal-400 outline-teal-400 text-white active:outline-teal-500 hover:outline-teal-500': ButtonVariant.success == variant && outlined,
      'text-cyan-300 outline-cyan-300 text-white active:outline-cyan-500 hover:outline-cyan-500': ButtonVariant.info == variant && outlined,
      'text-amber-400 outline-amber-400 text-white active:outline-amber-500 hover:outline-amber-500': ButtonVariant.warning == variant && outlined,
      'text-red-400 outline-red-400 text-white active:outline-red-500 hover:outline-red-500': ButtonVariant.danger == variant && outlined
    }),
    children: label
  });
};
...
//# sourceMappingURL=main.aca5a2c6c16654b7b1d0.hot-update.js.map