...
var Badge = function Badge(_ref) {
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__["jsx"])("span", {
    className: classnames__WEBPACK_IMPORTED_MODULE_4___default()({
      ...
      // Outline none
      'bg-gray-300 text-gray-600 ': BadgeVariant["default"] == variant,
      'bg-teal-300 text-teal-600': BadgeVariant.primary == variant,
      'bg-orange-400 text-orange-600 ': BadgeVariant.secondary == variant,
      'bg-teal-400  text-teal-600': BadgeVariant.success == variant,
      'bg-cyan-300 text-cyan-600': BadgeVariant.info == variant,
      'bg-amber-400 text-amber-600': BadgeVariant.warning == variant,
      'bg-red-400 text-red-600 ': BadgeVariant.danger == variant,
      // Outline
...
//# sourceMappingURL=main.1fa93c283a4c69c7be1b.hot-update.js.map