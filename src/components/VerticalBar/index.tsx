    ...
    <>
      <aside className="h-full">
        <div
          ...
          style={{ background: barColor ? barColor : "white" }}
        >
          {hasLogo ? (
            <div className="h-16 mt-2 justify-start flex flex-col">
              <svg width="40" height="20" viewBox="0 0 70 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                  ...
                  >
                    <stop offset="0.18" stopColor="#3CDBC0" />
                    <stop offset="0.32" stopColor="#38D5C1" />
                    <stop offset="0.49" stopColor="#2DC5C5" />
                    <stop offset="0.69" stopColor="#1AABCC" />
                    <stop offset="0.9" stopColor="#0188D5" />
                    <stop offset="0.91" stopColor="#0086D6" />
                  </linearGradient>
                </defs>
              </svg>
            </div>
          ...
          <div className="flex justify-end flex-col space-y-2">
            ...
            <a
              ...
              style={{ color: iconsColor ? iconsColor : "gray" }}
            >
