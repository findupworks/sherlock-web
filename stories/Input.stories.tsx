...
export default {
  ...
  */
  ...
  args: {
    ...
    placeholder: "",
    isVisible: false,
    selectorItems: [{label: 'Opção 01', value: '1'}, {label: 'Opção 02', value: '2'}]
  ...
  argTypes: {
    ...
    isVisible: {
      control: 'boolean',
      description: 'Controla a exibiçação do icone de olho aberto/fechado para esconder o que está escrito no input, no tipo default.'
    },
    tag: {
      type: "boolean",
